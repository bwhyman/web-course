...
以及Servlet/fetch/JDBC/异步非阻塞Servlet&Filter等基于java的服务器端技术，为后续Web系统框架(Springboot+SpringCloud+Vue)/移动终端软件设计(Flutter)课程提供支持
...
取消EL/JSTL技术内容，基于jquery+fetch实现前后端分离动态网页渲染。
